...
public class Empleado {
	...
	public Empleado() {
		this.idLocal=asignarID();//creamos un constructor y le asignamos una id
	}
	...
	public Empleado(String nombre, String dni, String telefono, double sueldo) {
		...
		this.sueldo = sueldo;
		this.idLocal=asignarID(); //contructor con todos los datos y asignamos id
	...
	public void mostrarDatos() {
		System.out.println("El id es: "+idLocal);
